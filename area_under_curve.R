...
# here's what the function outputs
# don't be surprised if it is slightly slow and returns a lot of summarize messages
# the messages will disappear when you load the function into the package
auc_test(mydata)
